...
const _default = {
  colors: {
    ...
    brand: twColors.teal[600],
    brandText: twColors.white,

    primary: twColors.teal[500],
    primaryText: twColors.white,

    primaryLight: twColors.teal[50],
    primaryLightText: twColors.teal[900],

    primaryDark: twColors.teal[700],
    primaryDarkText: twColors.white,
  ...
  nav: {
    bg: this.colors.brand,
    link: "bg-brand text-gray-100 hover:text-white focus:text-white",
  },
