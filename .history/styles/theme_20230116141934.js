...
const _default = {
  colors: {
    primary: "#14b8a6", //this will be read by tailwind.config
    primaryLight: twColors.teal[300], //can also set a tw default color here
    secondary: "#f1f1f1", //this will be read by tailwind.config
  },
