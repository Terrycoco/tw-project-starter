...
const _default = {
  ...
  text: {
    ...
    h1: "font-display leading-none text-h1 mt-6 text-blackish font-light tracking-tightest",
    h2: "font-display leading-none text-60px mt-8 font-bold text-blackish",
    h3: "font-base font-medium leading-none text-48px text-secondary font-bold mt-7",
    h4: "text-34px",
    h5: "text-24px",
    h6: "text-20px",
    p: "mt-3 max-w-[500px] text-16px",
    kicker:
      "font-special mb-0 text-10px leading-tight text-normal uppercase text-secondary dark:text-white",
