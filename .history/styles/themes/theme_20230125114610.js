...
const _default = {
  ...
  text: {
    base: "text-body1 font-base text-blackish leading-normal",
    h1: "font-display font-light leading-none text-h1 mt-6 text-blackish tracking-tightest",
    h2: "font-display leading-none text-3xl mt-8 font-bold text-blackish",
    h3: "font-base font-medium leading-none text-lg text-secondary font-bold mt-7",
    p: "mt-3 max-w-[500px]",
    kicker:
      "font-special mb-0 text-xl leading-tight font-semibold text-secondary dark:text-white",
