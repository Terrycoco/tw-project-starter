...
const _default = {
  ...
  text: {
    ...
    subhead:
      "text-xl sm:text-xl font-display leading-snug mt-8 font-light text-blackish text-opacity-90",
    ...
    kicker:
      "text-sm text-kicker mb-0 tracking-widest leading-tight font-bold uppercase text-brand dark:text-white",
