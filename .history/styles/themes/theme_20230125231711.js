...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-sm-head md:text-md-head font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead:
      "text-sm-subhead md:text-md-subhead font-display leading-none mt-8 font-light text-blackish shrink-2",
