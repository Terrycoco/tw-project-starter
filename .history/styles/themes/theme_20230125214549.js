...
const _default = {
  ...
  text: {
    ...
    heading:
      "font-display leading-none text-heading mt-6 text-blackish font-light shrink-4",
    subhead:
      "font-display leading-none text-subhead mt-8 font-light text-blackish shrink-2",
