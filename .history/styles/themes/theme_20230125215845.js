...
const _default = {
  ...
  text: {
    base: "text-base font-base text-blackish leading-normal",
    heading: "font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead: "font-display leading-none mt-8 font-light text-blackish shrink-2",
    // h3: "font-base font-medium leading-none text-48px text-secondary font-bold mt-7 shrink-0",
    // h4: "text-34px",
    // h5: "text-24px",
    // h6: "text-20px",
    p: "mt-3 max-w-[500px] text-base",
    label: "text-sm font-normal text-opacity-80",
    kicker:
      "font-base mb-0 tracking-widest leading-tight text-bold uppercase text-secondary dark:text-white",
