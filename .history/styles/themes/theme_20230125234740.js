...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-2xl sm:text-4xl font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead:
      "text-xl sm:text-2xl font-display leading-none mt-8 font-light text-blackish shrink-2",
    h3: "font-base font-medium leading-none text-48px text-secondary  mt-7 shrink-0",
    // h4: "text-34px",
    // h5: "text-24px",
    // h6: "text-20px",
