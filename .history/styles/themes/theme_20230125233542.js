...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-smh md:text-mdh font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead:
      "text-smsh md:text-mdsh font-display leading-none mt-8 font-light text-blackish shrink-2",
