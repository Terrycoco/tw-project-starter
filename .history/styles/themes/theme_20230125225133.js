...
const _default = {
  ...
  text: {
    base: "text-16p font-base text-blackish leading-normal",
    heading:
      "text-21p md:text-35p font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead:
      "text-subhead font-display leading-none mt-8 font-light text-blackish shrink-2",
