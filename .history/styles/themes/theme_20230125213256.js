...
const _default = {
  ...
  text: {
    ...
    h1: "font-display leading-none text-heading mt-6 text-blackish font-light shrink-4",
    h2: "font-display leading-none text-subheading mt-8 font-light text-blackish shrink-2",
