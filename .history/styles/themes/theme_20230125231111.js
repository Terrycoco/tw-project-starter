...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-smHead md:text-mdHead font-display leading-none mt-6 text-blackish font-light shrink-4",
    subhead:
      "text-smSubH md:text-mdSubH font-display leading-none mt-8 font-light text-blackish shrink-2",
