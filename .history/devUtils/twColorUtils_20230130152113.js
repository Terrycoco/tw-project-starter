...
export const makeCustomShades = (hex, parent) => {
  console.log("hex", hex, "parent", parent);
  let customShades = {};
  ...
  if (twColorList.includes(parent)) {
    ...
    keys.forEach((key, idx) => {
      ...
      let obj = makeColorObj(`${parent}-${key}`, parent, key, shadehex);
