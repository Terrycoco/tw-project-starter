...
const Navbar = (props) => {
  ...
  console.log("outerclass header", outer);
  ...
  return (
    <>
      <div className={`sticky top-0 left-0 w-screen z-1000 `}>
        <nav
          className={`relative w-full flex flex-wrap items-center justify-between py-4 text-current hover:text-gray-700 focus:text-gray-700 shadow-none navbar navbar-expand-lg navbar-light  bg-[#0f766e] h-20 md:h-24 `}
        >
