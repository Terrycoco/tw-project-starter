const ColorPicker = (props) => {
  ...
  return (
    <div classNameName="w-full absolute visible z-20 top-20 bg-white ">
      <h3 className="text-xs text-bold text-center p-10 ">
        Tailwind Default Colors
      </h3>
      <div className="w-1/2 mx-auto grid grid-cols-11 gap-1">
        <div className="text-md text-right"></div>
        ...
        <div className="text-md text-right">red</div>
        ...
        <div className="text-md text-right">rose</div>
        ...
        <div className="text-md text-right">pink</div>
        ...
        <div className="text-md text-right">fuchsia</div>
        ...
        <div className="text-md text-right">purple</div>
        ...
        <div className="text-md text-right">violet</div>
        ...
        <div className="text-md text-right">indigo</div>
        ...
        <div className="text-md text-right">blue</div>
        ...
        <div className="text-md text-right">sky</div>
        ...
        <div className="text-md text-right">cyan</div>
        ...
        <div className="text-md text-right">teal</div>
        ...
        <div className="text-md text-right">emerald</div>
        ...
        <div className="text-md text-right">green</div>
        ...
        <div className="text-md text-right">lime</div>
        ...
        <div className="text-md text-right">yellow</div>
        ...
        <div className="text-md text-right">amber</div>
        ...
        <div className="text-md text-right">orange</div>
        ...
        <div className="text-md text-right">stone</div>
        ...
        <div className="text-md text-right">neutral</div>
        ...
        <div className="text-md text-right">zinc</div>
        ...
        <div className="text-md text-right">gray</div>
        ...
        <div className="text-md text-right">slate</div>
