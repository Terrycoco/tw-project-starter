...
const Navbar = (props) => {
  ...
  console.log("navbar receives: ", theme.layout.header);
  //styles
  let outer = `
   relative
   w-full
   ...
   `;
  outer = props.className ? twMerge(outer, props.className) : outer;
  ...
  return (
    <>
      <div
        className={`sticky top-0 left-0 w-screen z-1000 ${theme.layout.header}`}
      >
        <nav className={outer}>
