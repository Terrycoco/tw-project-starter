const ColorPicker = (props) => {
  ...
  return (
    <div className="p-3 w-1/2 absolute visible top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-50  ">
      <div className="text-xs text-black-700 text-center mb-2 ">
        Tailwind Default Colors
      </div>

      <div className="w-full mx-auto grid grid-cols-11 gap-1 border border-blue-2">
