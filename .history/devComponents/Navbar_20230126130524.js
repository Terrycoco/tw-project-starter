...
const Navbar = (props) => {
  ...
  let outer = `
   ...
   `;
  outer = twMerge(outer, theme.layout.header);
  outer = twMerge(outer, props.className);
  console.log("outerclassheader", outer);
  ...
  return (
    <>
      <div className={`sticky top-0 left-0 w-screen z-1000 `}>
        <nav
          className={`relative w-full flex flex-wrap items-center justify-between py-4 text-current hover:text-gray-700 focus:text-gray-700 shadow-none navbar navbar-expand-lg navbar-light __className_442174 bg-[#18181b] h-20 md:h-24 __className_442174 `}
        >
