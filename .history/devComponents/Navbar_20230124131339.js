...
const Navbar = (props) => {
  ...
  return (
    <div className="sticky top-0 left-0 h-18 z-20">
      <SimpleModal id="modalReset" title="Are you sure you want to reset?" body="Restoring theme to original will lose any changes. Continue?" onClose={closeModal} actionTitle="Reset Theme" onActionClick={resetTheme}
      <nav className={outer}>
