...
export const twHexList = {
    ...
    '#000': { name: 'black', color: 'black', value: null, hex: '#000' },
    '#fff': { name: 'white', color: 'white', value: null, hex: '#fff' },
    '#000000': { name: 'black', color: 'black', value: null, hex: '#000' },
    '#ffffff': { name: 'white', color: 'white', value: null, hex: '#fff' },
    '#f8fafc': {
      name: 'slate-50',
      color: 'slate',
      value: '50',
    ...
    '#fff7ed': { name: 'orange-50', color: 'orange', value: '50', hex: '#fff7ed' },
    '#ffedd5': { name: 'orange-100', color: 'orange', value: '100', hex: '#ffedd5' },
    '#fed7aa': { name: 'orange-200', color: 'orange', value: '200', hex: '#fed7aa' },
    '#fdba74': { name: 'orange-300', color: 'orange', value: '300', hex: '#fdba74' },
    '#fb923c': { name: 'orange-400', color: 'orange', value: '400', hex: '#fb923c' },
    '#f97316': { name: 'orange-500', color: 'orange', value: '500', hex: '#f97316' },
    '#ea580c': { name: 'orange-600', color: 'orange', value: '600', hex: '#ea580c' },
    '#c2410c': { name: 'orange-700', color: 'orange', value: '700', hex: '#c2410c' },
    '#9a3412': { name: 'orange-800', color: 'orange', value: '800', hex: '#9a3412' },
    '#7c2d12': { name: 'orange-900', color: 'orange', value: '900', hex: '#7c2d12' },
    '#fffbeb': { name: 'amber-50', color: 'amber', value: '50', hex: '#fffbeb' },
    '#fef3c7': { name: 'amber-100', color: 'amber', value: '100', hex: '#fef3c7' },
    '#fde68a': { name: 'amber-200', color: 'amber', value: '200', hex: '#fde68a' },
    '#fcd34d': { name: 'amber-300', color: 'amber', value: '300', hex: '#fcd34d' },
    '#fbbf24': { name: 'amber-400', color: 'amber', value: '400', hex: '#fbbf24' },
    '#f59e0b': { name: 'amber-500', color: 'amber', value: '500', hex: '#f59e0b' },
    '#d97706': { name: 'amber-600', color: 'amber', value: '600', hex: '#d97706' },
    '#b45309': { name: 'amber-700', color: 'amber', value: '700', hex: '#b45309' },
    '#92400e': { name: 'amber-800', color: 'amber', value: '800', hex: '#92400e' },
    '#78350f': { name: 'amber-900', color: 'amber', value: '900', hex: '#78350f' },
    '#fefce8': { name: 'yellow-50', color: 'yellow', value: '50', hex: '#fefce8' },
    '#fef9c3': { name: 'yellow-100', color: 'yellow', value: '100', hex: '#fef9c3' },
    '#fef08a': { name: 'yellow-200', color: 'yellow', value: '200', hex: '#fef08a' },
    '#fde047': { name: 'yellow-300', color: 'yellow', value: '300', hex: '#fde047' },
    '#facc15': { name: 'yellow-400', color: 'yellow', value: '400', hex: '#facc15' },
    '#eab308': { name: 'yellow-500', color: 'yellow', value: '500', hex: '#eab308' },
    '#ca8a04': { name: 'yellow-600', color: 'yellow', value: '600', hex: '#ca8a04' },
    '#a16207': { name: 'yellow-700', color: 'yellow', value: '700', hex: '#a16207' },
    '#854d0e': { name: 'yellow-800', color: 'yellow', value: '800', hex: '#854d0e' },
    '#713f12': { name: 'yellow-900', color: 'yellow', value: '900', hex: '#713f12' },
    ...
    '#dcfce7': { name: 'green-100', color: 'green', value: '100', hex: '#dcfce7' },
    '#bbf7d0': { name: 'green-200', color: 'green', value: '200', hex: '#bbf7d0' },
    '#86efac': { name: 'green-300', color: 'green', value: '300', hex: '#86efac' },
    '#4ade80': { name: 'green-400', color: 'green', value: '400', hex: '#4ade80' },
    '#22c55e': { name: 'green-500', color: 'green', value: '500', hex: '#22c55e' },
    '#16a34a': { name: 'green-600', color: 'green', value: '600', hex: '#16a34a' },
    '#15803d': { name: 'green-700', color: 'green', value: '700', hex: '#15803d' },
    '#166534': { name: 'green-800', color: 'green', value: '800', hex: '#166534' },
    '#14532d': { name: 'green-900', color: 'green', value: '900', hex: '#14532d' },
    '#ecfdf5': { name: 'emerald-50', color: 'emerald', value: '50', hex: '#ecfdf5' },
    '#d1fae5': {
      name: 'emerald-100',
      color: 'emerald',
      value: '100',
    ...
    '#eef2ff': { name: 'indigo-50', color: 'indigo', value: '50', hex: '#eef2ff' },
    '#e0e7ff': { name: 'indigo-100', color: 'indigo', value: '100', hex: '#e0e7ff' },
    '#c7d2fe': { name: 'indigo-200', color: 'indigo', value: '200', hex: '#c7d2fe' },
    '#a5b4fc': { name: 'indigo-300', color: 'indigo', value: '300', hex: '#a5b4fc' },
    '#818cf8': { name: 'indigo-400', color: 'indigo', value: '400', hex: '#818cf8' },
    '#6366f1': { name: 'indigo-500', color: 'indigo', value: '500', hex: '#6366f1' },
    '#4f46e5': { name: 'indigo-600', color: 'indigo', value: '600', hex: '#4f46e5' },
    '#4338ca': { name: 'indigo-700', color: 'indigo', value: '700', hex: '#4338ca' },
    '#3730a3': { name: 'indigo-800', color: 'indigo', value: '800', hex: '#3730a3' },
    '#312e81': { name: 'indigo-900', color: 'indigo', value: '900', hex: '#312e81' },
    '#f5f3ff': { name: 'violet-50', color: 'violet', value: '50', hex: '#f5f3ff' },
    '#ede9fe': { name: 'violet-100', color: 'violet', value: '100', hex: '#ede9fe' },
    '#ddd6fe': { name: 'violet-200', color: 'violet', value: '200', hex: '#ddd6fe' },
    '#c4b5fd': { name: 'violet-300', color: 'violet', value: '300', hex: '#c4b5fd' },
    '#a78bfa': { name: 'violet-400', color: 'violet', value: '400', hex: '#a78bfa' },
    '#8b5cf6': { name: 'violet-500', color: 'violet', value: '500', hex: '#8b5cf6' },
    '#7c3aed': { name: 'violet-600', color: 'violet', value: '600', hex: '#7c3aed' },
    '#6d28d9': { name: 'violet-700', color: 'violet', value: '700', hex: '#6d28d9' },
    '#5b21b6': { name: 'violet-800', color: 'violet', value: '800', hex: '#5b21b6' },
    '#4c1d95': { name: 'violet-900', color: 'violet', value: '900', hex: '#4c1d95' },
    '#faf5ff': { name: 'purple-50', color: 'purple', value: '50', hex: '#faf5ff' },
    '#f3e8ff': { name: 'purple-100', color: 'purple', value: '100', hex: '#f3e8ff' },
    '#e9d5ff': { name: 'purple-200', color: 'purple', value: '200', hex: '#e9d5ff' },
    '#d8b4fe': { name: 'purple-300', color: 'purple', value: '300', hex: '#d8b4fe' },
    '#c084fc': { name: 'purple-400', color: 'purple', value: '400', hex: '#c084fc' },
    '#a855f7': { name: 'purple-500', color: 'purple', value: '500', hex: '#a855f7' },
    '#9333ea': { name: 'purple-600', color: 'purple', value: '600', hex: '#9333ea' },
    '#7e22ce': { name: 'purple-700', color: 'purple', value: '700', hex: '#7e22ce' },
    '#6b21a8': { name: 'purple-800', color: 'purple', value: '800', hex: '#6b21a8' },
    '#581c87': { name: 'purple-900', color: 'purple', value: '900', hex: '#581c87' },
    '#fdf4ff': { name: 'fuchsia-50', color: 'fuchsia', value: '50', hex: '#fdf4ff' },
    '#fae8ff': {
      name: 'fuchsia-100',
      color: 'fuchsia',
      value: '100',
  ...
  {
    inherit: { name: 'inherit', color: 'inherit', value: null, hex: 'inherit' },
    currentColor: {
      name: 'current',
      color: 'current',
      value: null,
