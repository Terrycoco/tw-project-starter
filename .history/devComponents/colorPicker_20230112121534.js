...
const ColorPicker = (visible, ...props) => {
  ...
  const [cl, setCl] = useState(
    "p-3 w-1/2 absolute visible top-0 right-0 bg-white border-2 border-slate-900 shadow-left"
  );
  useEffect(() => {
    if (visible) {
      setCl(
        "p-3 w-1/2 absolute visible top-0 right-0 bg-white border-2 border-slate-900 shadow-left visible"
      );
    } else {
      setCl("invisible");
    }
