...
const ColorPicker = (props) => {
  ...
  return (
    <div className="p-3 w-1/2 absolute visible top-0 right-0 bg-white border-2 border-slate-900 shadow-left">
      ...
      <div className="w-full mx-auto grid grid-cols-12 gap-1 ">
        ...
        <div className={styles.top}>def</div>
        ...
        <ColorBlock color="bg-red"></ColorBlock>
        ...
        <ColorBlock color="bg-rose"></ColorBlock>
        ...
        <ColorBlock color="bg-pink"></ColorBlock>
