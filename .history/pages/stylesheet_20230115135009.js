        ...
        <section id="colors" className={styles.section}>
          <div id="colors-result" className={styles.result}>
            ...
            <div className="mt-3 flex h-10 ">
              ...
              <button
                className={`inline-block h-full px-3 text-middle bg-primary-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg transition duration-150 ease-in-out`}
            ...
            />
            Or play with Hex Colors!{" "}
            <Link href="https://color.adobe.com/create/color-wheel">
              Adobe Colors
            </Link>
          </div>
