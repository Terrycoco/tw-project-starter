...
const styles = {
  ...
  palette: {
    ...
    primaryLight: "bg-primary-light text-primary-light-text",
    primaryDark: "bg-primary-dark text-primary-dark",
    ...
    if (isParent === true) {
      return (
        <>
          <div
            id={key}
            className="text-primary-dark font-bold text-sm uppercase px-4"
          >
            {key}
          </div>
      ...
      return (
        <Textarea
          ...
          name={key}
          label={key}
          labelStyle="text-primary-dark font-bold"
  ...
  return (
    <div id="page" className="w-full min-h-screen">
      ...
      <FlexLayout>
        ...
        <FlexColumn key="playground" className="w-1/3 bg-primary-light pl-3">
