...
const styles = {
  ...
  play: "space-y-2 py-6 px-3 bg-primary-light",
  palette: {
    primary: "bg-primary",
    ...
    if (isParent === true) {
      return (
        <>
          <div
            id={key}
            className="text-primary-light font-bold text-sm uppercase pt-3"
          >
            {key}
          </div>
  ...
  return (
    <div id="page" className="w-full min-h-screen">
      ...
      <FlexLayout>
        ...
        <FlexColumn key="playground" className={styles.play}>
          <h2 className="text-center">MY THEME</h2>
