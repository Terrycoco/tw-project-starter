        ...
        <div className="bg-white text-left p-12 mb-12">
          ...
          <section className="mb-12">
            ...
            <div className="py-5 flex items-center justify-start space-x-8">
              ...
              <div className="flex flex-col text-center">
                <div className="w-36 h-36 bg-secondary75 rounded-full"></div>
                <span>secondary75</span>
              </div>
              <div className="flex flex-col text-center">
                <div className="w-36 h-36 bg-secondary50 rounded-full"></div>
                <span>secondary50</span>
              </div>
              <div className="flex flex-col text-center">
                <div className="w-36 h-36 bg-secondary25 rounded-full"></div>
                <span>secondary25</span>
              </div>
              <div className="flex flex-col text-center">
                <div className="w-36 h-36 bg-secondary10 rounded-full"></div>
                <span>secondary10</span>
              </div>
              <div className="flex flex-col text-center">
                <div className="w-36 h-36 bg-secondary5 rounded-full"></div>
                <span>secondary5</span>
              </div>
            </div>
          </section>
