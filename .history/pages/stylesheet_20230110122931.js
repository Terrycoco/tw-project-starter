  ...
  return (
    <div id="page" className="w-screen min-h-screen">
      ...
      <div className="w-screen min-h-screen overflow-x-hidden overflow-y-hidden">
        <section id="colors" className="grid grid-cols-4 p-6 ">
          <div id="colors-result" className="col-span-3">
          ...
          <div id="colors-play" className="bg-primary-200"></div>
        </section>
        <section id="typography" className="p-6">
          <div id="typography-result" className="col-span-3">
          ...
          <div id="typography-play" className="bg-primary-200"></div>
        </section>
      </div>
    </div>
  );
