...
const Stylesheet = (props) => {
  ...
  return (
    <div id="page" className={`${mytheme.page.basic}`}>
      ...
      <ThemeShower visible={showTheme} theme={theme} />
      ...
      >
        <div className={theme.text.kicker}>Color Palette</div>
        <h3 className={theme.text.h3}>Named Colors</h3>
        <p className="text-xs text-medium mt-1 mb-3">
        ...
        <FlexLayout className="gap-5" key="topsection">
          ...
          <FlexColumn key="colorplay" className="w-1/3">
            ...
            <ColorTester colorObj={selectedColorObj} />
            <div
        ...
        <FlexLayout key="themeplay" className="gap-5">
          <FlexColumn key="textVals" className="w-full md:w-2/3">
            <div>
              ...
              <p className={theme.text.p}>
                Paragraphs should be limited in length, so as to be readable. I
                found 500px is a good readable max, so max-w-lg works at 512px.
              </p>
            </div>
          </FlexColumn>
