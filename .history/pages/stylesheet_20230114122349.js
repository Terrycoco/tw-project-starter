        ...
        <section id="colors" className={styles.section}>
          <div id="colors-result" className={styles.result}>
            ...
            <div className="flex h-10">
              <div
                className={`mt-2  w-1/2 border border-black text-md text-bold inline-block align-middle text-center ${selectedColor} ${textColor}`}
              >
                {`${selectedColor}`}
              </div>
              <button
            ...
            <HexInput
              ...
              key="hexColor"
              style={`mt-2 p-3 w-1/2 h-10 border border-black text-md text-bold  bg-[${hexColor}]`}
            />
          </div>
