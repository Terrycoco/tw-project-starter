...
const Stylesheet = (props) => {
  ...
  const getFontClass = (elementClass, name) => {
    console.log("requesting ", elementClass, name);
    if (elementClass.includes(`font-${elementClass}`)) {
      return " " + getFontClassName(theme.fonts[name]);
    } else {
