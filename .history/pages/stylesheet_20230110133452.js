...
const styles = {
  ...
  play: "flex flex-col space-y-2 p-3 bg-primary-200 text-xs",
  palette: {
      ...
      <div className="w-full min-h-screen overflow-x-hidden overflow-y-hidden px-6">
        ...
        <section id="typography" className={styles.section}>
          ...
          <div id="typography-play" className={styles.play}>
            ...
            <Textarea label="H1">{styles.h1}</Textarea>
            <Textarea label="H2">{styles.h2}</Textarea>
            <Textarea label="H3">{styles.h1}</Textarea>
            <Textarea label="Base">{styles.base}</Textarea>
            <Textarea label="Kicker">{styles.h1}</Textarea>
          </div>
        </section>
      </div>
    </div>
