        ...
        <FlexLayout key="themeplay" className="gap-5">
          <FlexColumn key="textVals" className="w-full md:w-2/3">
            <div>
              ...
              <H2 className={getClasses("text", "h2")}>H2 Headline</H2>

              <H3 className={getClasses("text", "h3")}>This is H3</H3>
              <div className={getClasses("text", "h4")}>This is H4</div>
              <div className={getClasses("text", "h5")}>This is H5</div>
              <div className={getClasses("text", "h6")}>This is H6</div>
