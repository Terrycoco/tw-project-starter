  ...
  return (
    <div id="page" className="">
      ...
      <div className=" w-screen min-h-screen overflow-x-hidden overflow-y-hidden">
        <section id="colors" className="grid grid-cols-2 p-6 relative">
          <div id="colors-result" className="absolute top-0 right-0">
          ...
          <div id="colors-play" className="bg-primary-200 w-1/5"></div>
        </section>
