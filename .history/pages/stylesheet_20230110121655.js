...
const Stylesheet = (props) => {
  ...
  return (
    <div className="">
      ...
      <div className="relative w-screen min-h-screen overflow-x-hidden overflow-y-hidden">
      ...
      <div className="bg-primary-100 min-h-screen w-1/4 absolute right-0 top-0 p-6">
        <section className="flex flex-col space-y-2" id="typography-controls">
          <div className="kicker">Typography Controls</div>
        </section>
      </div>
    </div>
  );
