...
const styles = {
  h1: "font-medium leading-tight text-5xl mt-0 mb-2 text-blue-600",
  h2: "font-medium leading-tight text-4xl mt-0 mb-2 text-blue-600",
};
        ...
        <div className="relative">
          <div className="overflow-y-scroll">
            <section id="colors" className="p-6 ">
              <h1 className={styles.h1}>Color Palette</h1>
