  ...
  return (
    <div id="page" className={mytheme.page.basic}>
      ...
      >
        ...
        <FlexLayout>
          <FlexColumn key="guide" className="w-2/3">
            <div id="colors-result" className={styles.result}>
              ...
              <FlexColumn key="palette" className="w-2/3 bg-primary-light px-3">
                {loopThroughTheme({ palette }, true)}
              </FlexColumn>
            </div>
          </FlexColumn>
          <FlexColumn key="colorplay" className="pl-6 w-1/3">
            ...
            <HexInput
              ...
              onChange={handleHexColor}
              key="hexColor"
              style={` p-3 w-1/2 h-10 border border-blackish text-sm font-bold  bg-[${hexColor}]`}
            />
      ...
      <section
        ...
        onClick={(e) => toggleColorPicker(e, false)}
      >
        <FlexLayout key="typography">
          <FlexColumn key="playground" className="w-1/3 px-3">
