        ...
        <FlexLayout key="themeplay" className="gap-5">
          <FlexColumn key="textVals" className="w-full md:w-2/3">
            <div>
              ...
              <p className={getClasses("text", "p")}>
                Try to limit your number of fonts used. You may have one for the
                content, one for headers, and maybe one more if your need
                something special. Four categories should be enough.
              </p>
              <p className={getClasses("text", "p")}>
