...
const Stylesheet = (props) => {
  ...
  return (
    <div id="page" className={`${mytheme.page.basic}`}>
      ...
      >
        <div className={theme.text.kicker}>Project Colors</div>
        ...
        <FlexLayout key="themeplay" className="gap-5">
          <FlexColumn key="textVals" className="w-full md:w-2/3">
            <div>
              ...
              <ul>
                <li key="wmd">max-w-md (28rem/448px)</li>
                <li key="wlg">max-w-lg (32rem/512px)</li>
                <li key="wxl">max-w-xl (36rem/576px)</li>
              </ul>
            </div>
          </FlexColumn>
