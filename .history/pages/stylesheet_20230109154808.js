...
const Stylesheet = (props) => {
  return (
    <div className="">
      ...
      <div className="snap-y scroll-smooth scroll-mt-20 w-screen min-h-screen overflow-x-hidden overflow-y-hidden">
        <div className="relative">
          <div className="overflow-y-scroll">
            <section id="colors" className="anchored p-6 ">
              <h1>Color Palette</h1>
            ...
            <section id="typography" className="anchored p-6">
              <h1>Typography</h1>
