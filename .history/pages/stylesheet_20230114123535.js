      ...
      <div className="relative w-full min-h-screen overflow-x-hidden overflow-y-hidden px-6">
        ...
        <section id="colors" className={styles.section}>
          <div id="colors-result" className={styles.result}>
            ...
            <div className="mt-3 flex h-10 border border-blue-500">
              <div
                className={`w-1/2 min-h-full p-3 border border-black text-sm font-bold ${selectedColor} ${textColor}`}
              >
                {`${selectedColor}`}
              </div>
              <button
                className={`inline-block h-full text-middle bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out`}
            ...
            <HexInput
              ...
              key="hexColor"
              style={`mt-2 p-3 w-1/2 h-10 border border-black text-sm font-bold  bg-[${hexColor}]`}
            />
          </div>
