...
const Stylesheet = (props) => {
  ...
  const updateTheme = (newValue, name, cat) => {
    ...
    setTheme(newtheme);
    setStorage("theme", newtheme); //could also useEffect here
  };
  ...
  const getFontClass = (elementClass) => {
    ...
    if (elementClass.includes("font-display")) {
      return " " + getFontClassName(theme.fonts.display);
    } else if (elementClass.includes("font-sans")) {
      return " " + getFontClassName(theme.fonts.sans);
    } else if (elementClass.includes("font-serif")) {
      return " " + getFontClassName(theme.fonts.serif);
    } else if (elementClass.includes("font-mono")) {
      return " " + getFontClassName(theme.fonts.mono);
    }
  };
  ...
  return (
    <div id="page" className={` ${mytheme.page.basic} ${fontVariables}`}>
      ...
      />
      <ThemeShower key="themeShower" visible={showTheme} />
