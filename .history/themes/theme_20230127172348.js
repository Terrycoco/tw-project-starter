...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-4xl sm:text-5xl font-display leading-none py-5 text-blackish font-normal",
    subhead:
    ...
    kicker:
      "text-kicker tracking-wide leading-tight font-bold uppercase text-brand dark:text-white text-sm pb-2",
    subtext: "text-xs text-medium -mt-3",
    link: "text-secondary underline",
  },
  layout: {
    page: "w-screen min-h-screen bg-whitish mx-auto",
    container: "container m-6 p-6 mx-auto max-w-5xl",
    header: "bg-brand text-whitish hover:text-accent h-12 md:h-22 text-whitish",
  },
  buttons: {
