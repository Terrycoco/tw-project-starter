...
const _default = {
  ...
  text: {
    ...
    heading:
      "text-4xl sm:text-5xl font-display leading-none mb-5 text-blackish font-normal shrink-4",
    subhead:
      "text-2xl sm:text-3xl font-display leading-snug mb-8 -mt-1 font-light text-blackish text-opacity-90",
    h3: "font-base font-semibold leading-none text-secondary mb-4  shrink-0",
    p: "mb-3 max-w-md text-base leading-loose md:leading-normal",
    label: "text-xs font-normal text-opacity-80 mt-2",
    kicker:
      "text-kicker  tracking-widest leading-tight font-bold uppercase text-brand dark:text-white text-sm mb-2",
  ...
  layout: {
    ...
    section: {
      full: "p-0 w-screen",
      padded: "px-3 md:px-36 pt-12 md:pt-22",
    },
