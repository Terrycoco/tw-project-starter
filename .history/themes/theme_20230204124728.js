...
const _default = {
  ...
  buttons: {
    sm: "inline-block px-6 h-full bg-secondary-75 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-secondary-75 hover:shadow-lg focus:bg-secondary-75 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-secondary-75 active:shadow-lg transition duration-150 ease-in-out",
  },
};
