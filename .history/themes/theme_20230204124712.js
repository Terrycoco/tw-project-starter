...
const _default = {
  ...
  text: {
    ...
    subhead:
      "text-2xl sm:text-3xl font-display leading-snug mb-8 -mt-1 font-light text-blackish-75",
    ...
    label: "text-xs font-normal text-blackish-75 pt-2",
    ...
    navlink: "text-whitish hover:text-secondary ",
  },

  layout: {
    page: "w-screen min-h-screen mx-auto bg-whitish",
  ...
  buttons: {
    sm: "inline-block px-6 h-full bg-secondary-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-secondary-75 hover:shadow-lg focus:bg-secondary-75 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-secondary-75 active:shadow-lg transition duration-150 ease-in-out",
  },
};
