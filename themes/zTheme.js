...
const _default = {
  ...
  text: {
    h1: "font-display font-medium leading-none text-5xl mt-6 text-normal",
    h2: "leading-none text-3xl mt-8 mb-5 font-bold",
    ...
    p: "mt-3 max-w-[500px]",
    kicker:
      "mb-0 text-sm leading-6 font-semibold text-secondary dark:text-white",
